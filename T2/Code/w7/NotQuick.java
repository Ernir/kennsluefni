...
/******************************************************************************
 *  Compilation:  javac NotQuick.java
 *  Execution:    java NotQuick < input.txt
 ...
 *
 *  % java NotQuick < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *
 *  % java NotQuick < words3.txt
...
/**
 *  The {@code NotQuick} class provides static methods for sorting an
...
public class NotQuick {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println();
        for (int i = 0; i < a.length; i++) {
            String ith = (String) NotQuick.select(a, i);
            StdOut.println(ith);
        }
    }
