...
% \begin{frame}{Hagnýtingar á netum}
% \begin{itemize}
%  \item Til að hagnýta net má láta hnútana tákna hluti, síðan eru forrit skrifuð til að vinna með leggina (eða örvarnar)
%  \item Dæmi:
%  \begin{itemize}
%   \item Láta hnúta tákna strætóstoppistöðvar, leggirnir á milli þeirra akstursleiðirnar
%   \item Láta hnúta tákna rafmagnsstaura, leggirnir á milli þeirra rafmagnslínur
%   \item Láta hnúta tákna lönd, leggirnir á milli þeirra landamæri
%   \item Láta hnúta tákna fólk, leggirnir á milli þeirra vináttu
%  \end{itemize}
% \end{itemize}
% \end{frame}
