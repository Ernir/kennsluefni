...
Látum $R$ vera vensl frá mengi $A$ til mengis $B$ og $S$ vera vensl frá $B$ til mengis $C$. Þá skilgreinum við samsettu venslin $S \circ R$ með eftirfarandi:

$(x,z) \in S \circ R$ þá og því aðeins að til sé $y \in B$ þannig að $(x,y) \in R$ og $(y,z) \in S$.
\end{tcolorbox}
\end{frame}
