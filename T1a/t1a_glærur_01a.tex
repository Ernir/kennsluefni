...
\begin{itemize}
  ...
  \end{itemize}
  \item Það að forrita er að búa til útskýringar sem segja tölvunni hvað hún á að gera
...
\begin{itemize}
 ...
 \item Líkt og tungumál hafa forritunarmál setningar- og málfræði (e. \emph{syntax}) ásamt merkingarfræði (e. \emph{semantics})
 \begin{itemize}
...
Skoðum dæmi um heilt forrit - \href{https://raw.githubusercontent.com/Ernir/kennsluefni/master/T1a/Code/pendulumexample.m}{teikning pendúls}!
\end{frame}
