...
\end{verbatim}
 ...
 \begin{itemize}
  ...
  \begin{itemize}
   ...
   \item Allar skipanir inni í lykkjunni eru framkvæmdar einu sinni per gildi
  \end{itemize}
 \end{itemize}
\end{itemize}
\end{frame}
...
\vspace{\baselineskip}
\begin{enumerate}
 \item Skrifið Matlab-skipanaskrána \texttt{say5} sem biður notanda um streng og skrifar hann út fimm sinnum.
 \item Skrifið Matlab-fall sem tekur inn tölur $m$ og $n$ og skilar summunni $m + (m+1) + \ldots + n$.
 \item Skrifið Matlab-skipanaskrá sem skrifar út öll 99 erindin í laginu ``99 Bottles of Beer on the Wall''.
 \vspace{\baselineskip}
